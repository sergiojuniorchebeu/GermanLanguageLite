...
class Lesson2C9Page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, dynamic> lessonData = {
      ...
      "examples": [
        {"phrase": "Je vais vous poser une sonde urinaire.", "meaning": "Ich werde Ihnen einen Blasenkatheter legen."},
        {"phrase": "le set de sondage", "meaning": "das Katheterset"},
        {"phrase": "le collecteur à urine", "meaning": "der Urinbeutel"},
        {"phrase": "les champs stériles", "meaning": "die sterilen Abdecktücher"},
        {"phrase": "les gants stériles", "meaning": "die sterilen Handschuhe"}
      ],
    };
