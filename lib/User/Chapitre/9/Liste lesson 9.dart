...
class LessonList9Page extends StatefulWidget {
  const LessonList9Page({super.key});

  @override
  _LessonList9PageState createState() => _LessonList9PageState();
}

class _LessonList9PageState extends State<LessonList9Page> {
  final List<Map<String, dynamic>> _lessons = [
    {
      'title': "La perfusion",
      'description': "Die Infusion",
      'image': 'assets/img/saline.png',
      'onTapAction': () => const Lesson1C9Page(),
    },
    {
      'title': "La sonde urinaire",
      'description': "Der Blasenkatheter",
      'image': 'assets/img/medical.png',
      'onTapAction': () => const Lesson2C9Page(),
    },
    {
      ...
      'onTapAction': () => const Lesson3C9Page(),
    },
    {
      ...
      'onTapAction': () => const Lesson4C9Page(),
    },
  ];
