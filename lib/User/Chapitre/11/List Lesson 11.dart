...
class LessonList11Page extends StatefulWidget {
  const LessonList11Page({super.key});

  @override
  _LessonList11PageState createState() => _LessonList11PageState();
}

class _LessonList11PageState extends State<LessonList11Page> {
  final List<Map<String, dynamic>> _lessons = [
    {
      'title': "Le transfert et la sortie",
      'description': "Die Verlegung und die Entlassung",
      'image': 'assets/img/ambulance.png',
      'onTapAction': () => const Lesson1C11Page(),
    },
  ];
