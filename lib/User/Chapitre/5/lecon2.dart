...
class Lesson2C5Page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, dynamic> lessonData = {
      ...
      "examples": [
        {"phrase": "Le patient se plaint de...", "meaning": "Der Patient klagt über..."},
        {"phrase": "Prurit (m.)", "meaning": "Juckreiz (m.)"},
        {"phrase": "Accouphène (m.)", "meaning": "Tinnitus (m.)"},
        {"phrase": "Troubles du sommeil (m.) / Insomnie (f.)", "meaning": "Schlafstörungen (m.) / Schlaflosigkeit (f.)"},
        {"phrase": "Crampe (f.)", "meaning": "Krämpfe (f.)"},
        {"phrase": "Fatigue (f.)", "meaning": "Müdigkeit (f.)"},
        {"phrase": "Palpitations (f.)", "meaning": "Palpitationen (f.)"},
        {"phrase": "Sensation de malaise (f.)", "meaning": "Befinden sich schlecht (f.)"},
        {"phrase": "Vertige (m.)", "meaning": "Schwindel (m.)"},
        {"phrase": "Céphalées (f.)", "meaning": "Kopfschmerzen (f.)"}
      ],
    };
