...
class LessonList5Page extends StatefulWidget {
  const LessonList5Page({super.key});

  @override
  _LessonList5PageState createState() => _LessonList5PageState();
}

class _LessonList5PageState extends State<LessonList5Page> {
  final List<Map<String, dynamic>> _lessons = [
    {
      'title': "L'observation",
      'description': "Die Beobachtung",
      'image': 'assets/img/research.png',
      'onTapAction': () => const Lesson1C5Page(),
    },
    {
      'title': "L'écoute des plaintes",
      'description': "Das Zuhören der Beschwerden",
      'image': 'assets/img/doctor-visit.png',
      'onTapAction': () => const Lesson2C5Page(),
    },
  ];
